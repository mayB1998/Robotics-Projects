...
class Visual_Odometry():
    def __init__(self, data_dir, descriptor="ORB", num_features=3000, matcher="FLANN", show_matches=False):
        ...
        # self.images = self._load_images(os.path.join(data_dir, 'rgb'))
    ...
    def get_pose(self, q1, q2):
        ...
        _, R, t, _ = cv2.recoverPose(E, q1, q2, self.K, mask=mask)
...
def main(render=False, pass_gt=False):
    ...
    # data_dir = "/home/aniket/Downloads/data"
    ...
    for i in tqdm.tqdm(range(len(image_paths)), unit="pose"):
        if i == 0:
            cur_pose = gt_poses[0]
            ...
            # cv2.waitKey(10)
            q1, q2 = vo.get_matches(img0, img1)
